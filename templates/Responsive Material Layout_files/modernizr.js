...
<meta content="FHXP3Amh8n43mnHFmk29AalTwKbrlvY3I3aNQmtYW7c=" name="csrf-token" />

  <title>CodePen</title>

  <link href='//fonts.googleapis.com/css?family=Lato:400,700,900,400italic,700italic' rel='stylesheet'>
  <link href="http://assets.codepen.io/assets/global/global-MQ-1f07c82abc49f3ee6e7fbd1c7d8d833f.css" media="all" rel="stylesheet" type="text/css" />
  <link href="http://assets.codepen.io/assets/page/page-MQ-be065961e6a27b709a2bae16d862426f.css" media="all" rel="stylesheet" type="text/css" />
...
c0.22,3.235,2.907,5.75,6.151,5.75h3.091c1.706,0,3.335-0.706,4.5-1.95C99.498,96.805,100.098,95.135,99.986,93.431z"/>
  ...
  <a href="http://codepen.io/">
    ...
    <a href="/pen/" id="new" class="top-button button new-pen-button">
  ...
  <a href="#0" class="header-search-button">
    <svg viewBox="0 0 100 100" class="header-icon-mag">
  ...
  <div>
    ...
    <input type="search" name="q" id="q" class="search-input" value="" placeholder="Search Pens">

      <input type="hidden" name="limit" value="all">
      <!-- <input type="hidden" name="limit" value=""> -->

    <input type="hidden" name="depth" value="everything">
    <input type="hidden" name="show_forks" value="false">

  </div>
</form>


  <a href="#0" class="header-close-button">
    <svg viewBox="0 0 100 100" class="header-icon-x">
  ...
  <a href="https://s.codepen.io/login" class="button top-button login-button" id="login-button">Log In</a>

  <a href="/signup/" class="button top-button signup-button">Sign Up</a>
  ...
  <img alt="Error 404 - No Page Found" class="super-center" src="http://assets.codepen.io/assets/404/404.png" />

  <div id="overlay messagingjs-hide"></div>

  <footer class="site-footer">

  <div class="footer-left">
    &copy;2015 <a href="/">CodePen</a>
  ...
  <div class="footer-right">
    ...
    <div class="footer-word-links">
      ...
      <a href="http://blog.codepen.io/store/">
        Store
      </a>
      ...
      <a href="/pro/" class="footer-badge">
        <span class="badge badge-pro">PRO</span>
      </a>

      <a href="http://twitter.com/CodePen" class="footer-icon footer-icon-twitter">
        <svg viewBox="0 0 100 100">
  ...
  <input type="hidden" id="init-data" value="{&quot;__mobile&quot;:false,&quot;__cookieUsed&quot;:false,&quot;__turnOffJS&quot;:false,&quot;__sandboxVal&quot;:&quot;allow-scripts allow-pointer-lock allow-same-origin allow-popups allow-forms&quot;}">

  <script src="http://assets.codepen.io/assets/common/everypage-c30c666e4a5af0d330c51a6aa67baaa6.js" type="text/javascript"></script>
